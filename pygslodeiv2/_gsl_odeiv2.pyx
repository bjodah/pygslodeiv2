...
def adaptive(rhs, jac, cnp.ndarray[cnp.float64_t, mode='c'] y0, double x0, double xend, double atol,
             ...
             double dx_max=0.0, int autorestart=0, bool return_on_error=False, cb_kwargs=None, dx0cb=None, dx_max_cb=None):
    cdef:
    ...
    odesys = new PyOdeSys(ny, <PyObject *>rhs, <PyObject *>jac, NULL,
                          <PyObject *>cb_kwargs, -1, -1, 0, <PyObject *>dx0cb, <PyObject *>dx_max_cb)
    try:
...
def predefined(rhs, jac,
               ...
               bool return_on_error=False, cb_kwargs=None, dx0cb=None, dx_max_cb=None):
    cdef:
        int ny = y0.shape[y0.ndim - 1]
